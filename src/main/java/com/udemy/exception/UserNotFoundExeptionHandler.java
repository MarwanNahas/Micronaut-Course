...
//it will implement exeptionhandler from micronaut.http.server.exepetions not any other library the ExeptionHandler takes 2 arguments first the is T which is : Table Object so in our case its UserNotFoundExeption and the second is R which is : Return type of your handling (if this was some other web application we could have returned a rendered web page for this error )
@Singleton
